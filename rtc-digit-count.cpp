...
namespace rtc_digit_count {
	...
	template<typename value_type>
	std::vector<value_type> generate_random_integers(
		uint64_t count, benchmarksuite::random_generator<value_type>& rg, uint64_t min_digits = 1, uint64_t max_digits = max_decimal_digits<value_type>()) {
